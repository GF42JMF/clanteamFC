              ...
              {navItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`relative px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider transition-colors duration-300 z-10 ${isActive ? 'text-white' : 'text-gray-400 hover:text-white'}`}
                  >
                    {isActive && (
                      <motion.div
