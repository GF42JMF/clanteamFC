...
export const INITIAL_PLAYERS: Player[] = [
  ...
  { id: '2', name: 'Guillermo Fontes', age: 28, phone: '666666', jerseyNumber: 2, position: 'DEF', image: ASSETS.players.guilleF, stats: { matches: 18, goals: 2, assists: 3, mvp: 1 } },
  ...
  { id: '7', name: 'Gonzalo Ramos', age: 29, phone: '666666', jerseyNumber: 8, position: 'MID', image: ASSETS.players.gonzaloRamos, stats: { matches: 12, goals: 1, assists: 1, mvp: 0 } },
  { id: '8', name: 'Julián Rocha', age: 28, phone: '666666', jerseyNumber: 9, position: 'FWD', image: ASSETS.players.julian, stats: { matches: 20, goals: 22, assists: 5, mvp: 8 } },
  ...
  { id: '10', name: 'Guillermo Figueredo', age: 24, phone: '666666', jerseyNumber: 11, position: 'FWD', image: ASSETS.players.guilleFigueredo, stats: { matches: 8, goals: 3, assists: 1, mvp: 0 } },
  { id: '11', name: 'Agustín Werosch', age: 29, phone: '666666', jerseyNumber: 12, position: 'DEF', image: ASSETS.players.agustin, stats: { matches: 5, goals: 0, assists: 0, mvp: 0 } },
  { id: '12', name: 'Agustín Rocha', age: 27, phone: '666666', jerseyNumber: 13, position: 'MID', image: ASSETS.players.agustin, stats: { matches: 11, goals: 1, assists: 2, mvp: 0 } },
  { id: '13', name: 'Gastón Curbelo', age: 29, phone: '666666', jerseyNumber: 16, position: 'MID', stats: { matches: 17, goals: 3, assists: 5, mvp: 1 } },
  { id: '14', name: 'Santiago De Gouveia', age: 33, phone: '666666', jerseyNumber: 18, position: 'MID', stats: { matches: 9, goals: 0, assists: 1, mvp: 0 } },
  { id: '15', name: 'Enzo Rubín', age: 25, phone: '66666', jerseyNumber: 19, position: 'DEF', stats: { matches: 6, goals: 2, assists: 0, mvp: 0 } },
  { id: '16', name: 'Sebastián Sosa', age: 27, phone: '666666', jerseyNumber: 22, position: 'DEF', image: ASSETS.players.sebaSosa, stats: { matches: 13, goals: 0, assists: 1, mvp: 0 } },
  { id: '17', name: 'Gonzalo Jacques', age: 29, phone: '6662', jerseyNumber: 30, position: 'MID', stats: { matches: 15, goals: 2, assists: 3, mvp: 0 } },
  ...
  { id: '19', name: 'Matias Perez', age: 25, phone: '666666', jerseyNumber: 80, position: 'MID', image: ASSETS.players.matiasPerez, stats: { matches: 7, goals: 1, assists: 0, mvp: 0 } },
  { id: '20', name: 'Nahuel Martínez', age: 29, phone: '666666', jerseyNumber: 99, position: 'FWD', image: ASSETS.players.nahuelMartinez, stats: { matches: 10, goals: 4, assists: 2, mvp: 1 } },
];
