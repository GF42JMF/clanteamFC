             ...
             return (
               ...
               >
                  ...
                  `}>
                     {player ? (
                       <>
                         {/* Enhanced Image for Face Focus - REMOVED CROSSORIGIN to fix display */}
                         <img 
                 ...
                 {benchPlayers.map(player => (
                   ...
                   >
                      ...
                      <div className="w-10 h-10 rounded-full bg-black overflow-hidden border border-white/10">
                         {/* Removed CrossOrigin for PDF to fix display */}
                         <img src={player.image || ASSETS.players.default} className="w-full h-full object-cover object-top"/>
                      </div>
